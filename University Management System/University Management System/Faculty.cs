...
namespace University_Management_System
{
    class Faculty
    {
        ...
        public Faculty()
        {
            teaching_Hours = new Teaching_Hour[112];
        }
        ...
        public void AddCredit(params Teaching_Hour[] teaching_Hour)
        {
            foreach (var a in teaching_Hour)
            {
                ...
                {
                    Console.WriteLine("Can't Take More Than 21 Credits");
                    Console.WriteLine("Can't take any more course credit : " + a.CreditCount);
                }
